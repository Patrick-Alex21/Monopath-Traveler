...
public class BattleManager : Singleton<BattleManager>
{
    ...
    public void StartTargetingForHero(HeroCharBase hero)
    {
        ...
        BattleUIManager.Instance.HideCommandPanel();
        targetingSystem.StartTargeting(_heroBeingPlanned.CurrentIntent.Target, true, false);
    }
    ...
    public void StopTargetingFromMenu()
    {
        ...
        if (_heroBeingPlanned != null && targetingSystem != null)
            ApplyTargetToPlanningHero(targetingSystem.GetCurrentTarget());
    ...
    public void ApplyTargetToPlanningHero(CharacterBase targetEnemy)
    {
        if (_heroBeingPlanned == null || targetEnemy == null) return;
        if (CharacterManager.Instance.ActiveEnemies == null ||
            !CharacterManager.Instance.ActiveEnemies.Contains(targetEnemy)) return;
